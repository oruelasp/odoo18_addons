        ...
        return [{
            ...
            components: [
                ...
                { props: { key: 'json_shop_product_item', components: [
                    ...
                    { props: { key: 'show_add_to_cart', icon: 'fa fa-shopping-cart', label: _t('Mostrar añadir al carrito')}, componentRef: ThemeOptionCardBtnCheckbox },
                    { props: { key: 'show_wishlist', icon: 'fa fa-heart', label: _t('Mostrar lista de deseos')}, componentRef: ThemeOptionCardBtnCheckbox },
                    { props: { key: 'show_compare', icon: 'fa fa-retweet', label: _t('Mostrar comparar')}, componentRef: ThemeOptionCardBtnCheckbox },
                    { props: { key: 'show_quick_view', icon: 'fa fa-eye', label: _t('Mostrar vista rápida')}, componentRef: ThemeOptionCardBtnCheckbox },
                    { props: { key: 'show_similar_products', icon: 'fa fa-clone', label: _t('Mostrar productos similares')}, componentRef: ThemeOptionCardBtnCheckbox },
